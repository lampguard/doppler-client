...
import AddNewTeamModal from "../MyTeam/AddNewTeamModal";
...
const AppLayout = () => {
  ...
  const [showAddTeamModal, setShowAddNewTEamModal] = useState(false);
  ...
  return (
    <UserContext.Provider value={data?.data.user}>
      <TeamProvider>
        {showAddTeamModal && (
          <AddNewTeamModal
            showAddNewModal={showAddTeamModal}
            setShowAddNewModal={setShowAddNewTEamModal}
          />
        )}
